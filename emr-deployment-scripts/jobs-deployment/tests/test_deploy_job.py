...
class TestEmrFlinkRunner(unittest.TestCase):
    ...
    def test_should_restart_sql_job_with_latest_savepoint(self):
        ...
        new_job_manifest = self.a_valid_sql_job_manifest() \
        ...
        self.flink_cli_runner.start.assert_called_once()
        self.assert_that_call_argument_equals(self.flink_cli_runner.start, "savepoint_path",
    ...
    def test_should_start_sql_job_with_clean_state_if_query_has_changed(self):
        ...
        old_job_manifest = self.a_valid_sql_job_manifest() \
    ...
    def test_should_start_code_job_with_clean_state_if_not_running_and_no_previous_state(self):
        ...
        self.assert_that_call_argument_equals(self.flink_cli_runner.start, "savepoint_path", None)
        self.assert_that_list_call_argument_contains(self.flink_cli_runner.start, "python_flink_params",
    ...
    def assert_that_dict_call_argument_contains(self,
    ...
    def assert_that_list_call_argument_contains(self,
                                                mock_object: MagicMock,
                                                argument_name: str,
                                                expected_value: str) -> None:
        call_args = mock_object.call_args[1]
    ...
    def assert_that_call_argument_equals(self,
                                         mock_object: MagicMock,
                                         argument_name: str,
